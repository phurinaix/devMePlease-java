...
public class RegisterDisplay extends javax.swing.JFrame {
    ...
    private void registerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerActionPerformed
        boolean checkData = nametxt.getText().isEmpty() || passwordtxt.getText().isEmpty() || cPasswordtxt.getText().isEmpty();
        if(checkData){
    ...
    public void insertData(){
        ...
        if(password.equals(cPassword)){
            String sql = "insert into tbsocket value(" + "'" + name + "'," + "'" + password + "','" + ip + "')";
            try{
